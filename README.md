# JavaScript-Click-On-Correct-Button
...
<html>
<head>
    <title>Surask teisingus</title>
    <link rel="stylesheet" type="text/css" href="css.css">
    <meta name="author" content="Termissues">
    <meta charset="utf-8">
        ...
        <div class="row content">
            <div class="col-sm-2 sidenav">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="index_2.html">Apie žaidimą</a></li>
                </ul><br>
            </div>
            ...
            <div class="col-sm-9">
                ...
                <hr>
                <h2>Informacija apie temą</h2>
                <h5><span class="label label-danger">Nauja</span> <span class="label label-success">Šviežia</span> <span class="label label-warning">Informacija</span></h5><br>
                <p>Puslapis sukurtas naudojant BootStrap, CSS, HTML. <br> Taip pat buvo naudojamas JavaScript apačioje - žaidimo funkcionavimui.</p>
                <br><br>

                <h4><small>CARD GAME</small></h4>
                <hr>
                <h2>"Surask teisingus"</h2>
                <h5><span class="label label-danger">Nauja</span> <span class="label label-warning">Informacija</span></h5><br>
                <p>Surask teisingą atsakymą, surinkus nors du teisingus atsakymus, Jūs laimėsite. <br><br> <a href="kasparasM_20.12.03_07PT_2.html">DAUGIAU INFORMACIJOS ČIA!</a></p>
                <hr>

                <br>

                <!--JavaScript kodo dalis-->
                ...
                <script>
                    ...
                    //Funkcijos Teisingas/Neteisingas

                    //Neigiama funkcija - Neteisingas atsakymas
                ...
                <!--Mygtukai susieti su JavaScript pagal ID-->
